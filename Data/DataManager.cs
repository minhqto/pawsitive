    ...
    public class DataManager
    {
        ...
        public async Task<bool> seedData()
        {
            ...
            List<User> users = new List<User>()
            {
                ...
                new User{ SecurityStamp=Guid.NewGuid().ToString(), UserName="specialist1@example.com", Email="specialist1@example.com", FirstName="Zac", LastName ="George", Address=addresses.ElementAt(3), PhoneNumber="6475983256", SpecialistProfile=specialistProfiles.ElementAt(0), ImageUrl="https://images-na.ssl-images-amazon.com/images/I/B16UbTtfGAS.jpg"},
                new User{ SecurityStamp=Guid.NewGuid().ToString(), UserName="specialist2@example.com", Email="specialist2@example.com", FirstName="Joel", LastName ="Beckman", Address=addresses.ElementAt(4), PhoneNumber="6476986547", SpecialistProfile=specialistProfiles.ElementAt(1), ImageUrl="https://beckmansdogtraining.com/wp-content/uploads/2018/10/BECKMANs-DOG-TRAINING-9-e1539820915421.png"},
                new User{ SecurityStamp=Guid.NewGuid().ToString(), UserName="specialist3@example.com", Email="specialist3@example.com", FirstName="Emily", LastName ="L", Address = addresses.ElementAt(5), PhoneNumber="6471542568", SpecialistProfile = specialistProfiles.ElementAt(2), ImageUrl = "https://i.pinimg.com/originals/ab/93/e7/ab93e772f7e6ab4816f300efae8b8019.png"},
            };
